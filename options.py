...
def args_parser():
    ...
    parser.add_argument(
        "--root_path",
        type=str,
        default="dataset/stage_1_train_images",
        help="dataset root dir",
    )
    parser.add_argument(
        "--csv_file_train",
        type=str,
        default="dataset/stage_1_train.csv",
    ...
    parser.add_argument(
        "--csv_file_test",
        type=str,
        default="/research/pheng4/qdliu/hzyang/flsemi/adam/testing.csv",
    ...
    parser.add_argument("--local_ep", type=int, default=2, help="local epoch")
